...
import ir.msob.jima.crud.api.restful.service.domain.read.BaseGetByIdDomainCrudRestResource;

public interface GetByIdDomainCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends DomainCrudRepository<D, C>,
        S extends DomainCrudService<D, DTO, C, R>
        > extends BaseGetByIdDomainCrudRestResource<String, User, D, DTO, C, QueryBuilder, R, S> {
