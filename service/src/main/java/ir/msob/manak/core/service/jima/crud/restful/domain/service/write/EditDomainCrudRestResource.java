...
import ir.msob.jima.crud.api.restful.service.domain.write.BaseEditDomainCrudRestResource;

public interface EditDomainCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends DomainCrudRepository<D, C>,
        S extends DomainCrudService<D, DTO, C, R>
        > extends BaseEditDomainCrudRestResource<String, User, D, DTO, C, QueryBuilder, R, S> {
