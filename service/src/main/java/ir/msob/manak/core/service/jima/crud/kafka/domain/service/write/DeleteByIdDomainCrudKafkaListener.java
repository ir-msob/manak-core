...
import ir.msob.jima.crud.api.kafka.service.domain.write.BaseDeleteByIdDomainCrudKafkaListener;

public interface DeleteByIdDomainCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends DomainCrudRepository<D, C>,
        S extends DomainCrudService<D, DTO, C, R>
        > extends BaseDeleteByIdDomainCrudKafkaListener<String, User, D, DTO, C, QueryBuilder, R, S>
