...
import ir.msob.jima.crud.api.kafka.service.domain.read.BaseCountAllDomainCrudKafkaListener;

public interface CountAllDomainCrudKafkaListener<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends DomainCrudRepository<D, C>,
        S extends DomainCrudService<D, DTO, C, R>
        > extends BaseCountAllDomainCrudKafkaListener<String, User, D, DTO, C, QueryBuilder, R, S>
