...
import ir.msob.jima.crud.api.restful.service.domain.read.BaseGetManyDomainCrudRestResource;

public interface GetManyDomainCrudRestResource<
        D extends Domain,
        DTO extends Dto,
        C extends Criteria,
        R extends DomainCrudRepository<D, C>,
        S extends DomainCrudService<D, DTO, C, R>
        > extends BaseGetManyDomainCrudRestResource<String, User, D, DTO, C, QueryBuilder, R, S> {
